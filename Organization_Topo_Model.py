...
class Individual: 
    def __init__(self):
        ...
        #relationships --> network topology requires that each person have a set or people they communicate with 
        self.coworkers = [] #list will eventually contain positions in workforce  
...
class Organization: 
    ...
    def populate_org(self):
        ...
        for i in range(self.Org_size): 
            ...
            #set coworkers for each individual 
...
TO DO: 
    ...
    4. change interact() such that only people who are coworkers under the topology of organization are interacting
''' 
